...
public class ApprovedQuotationAdapter extends RecyclerView.Adapter<ApprovedQuotationAdapter.ViewHolder> {
    Context context;
    ArrayList<ApprovedQuotationModel> approvedQuotationModels;

    public ApprovedQuotationAdapter(FragmentActivity activity, ArrayList<ApprovedQuotationModel> approveArrayLst) {
        this.context = activity;
        this.approvedQuotationModels = approveArrayLst;
    }

    @Override
    public ApprovedQuotationAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.approved_quotation_cardview, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final ApprovedQuotationAdapter.ViewHolder holder, int position) {
